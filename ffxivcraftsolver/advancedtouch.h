...
#define AT_SYNTH_BRANDOFELEMENTS 108
...
#define AT_TOUCH_PATIENTTOUCH 206
...
struct atSolverResult		/* The collective result */
{
	...
	union
	{
		int hqPercent;		/* With the normal goal. Goes from 0 to 100 (times simulationsPerSequence) */
